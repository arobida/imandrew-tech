...
export const chapters: Chapter[] = [
  {
    ...
    index: '01',
    timecode: 'ORIGINS',
    title: 'From the Parade Deck to the Terminal',
    leadIn:
      'Most developer origin stories start with a computer science degree or a childhood spent modding games. Andrew\u2019s starts with twelve years of Marine Corps logistics, two combat tours, and a recruiting desk \u2014 and that\u2019s exactly what makes it worth hearing.',
    takeaway:
  ...
  },
  {
    ...
    index: '02',
    timecode: '2017 — 2024',
    title: 'Building in Public \u2014 Startup, Freelance, and Serverless at Scale',
    leadIn:
    ...
    questions: [
      ...
      },
      {
        ...
        timecode: '14:30',
        kind: 'ADZZ',
        q: 'ADZZ, 2023\u20132024 \u2014 Product Engineer at an affiliate-marketing company, and this is where the scale numbers show up: subscriber services across 30+ domains, IP geolocation on AWS Lambda, a retroactive update script touching 200,000+ subscribers. Pick one and walk us through how you architected it.',
        a: [
          'The serverless event pipeline is the one. Affiliate marketing is pure event flow \u2014 registrations, deposits, postbacks firing in real time across 30+ domains \u2014 and Lambda fit it perfectly: no idle servers, every event triggers exactly the compute it needs, and the cost scales with reality instead of with your anxiety.',
          'Around it we built validation chains \u2014 DNS and SMTP checks on emails, IP geolocation for geo-cloaking, PPC data ingestion \u2014 so junk died at the edge instead of polluting the database. Then came the war story: a retroactive update across 200,000+ subscriber records. Measure twice, run once. Dry runs, sampling, batched execution, rollback plan \u2014 because at that scale a bad script isn\u2019t a bug, it\u2019s an incident report.',
        ],
        ...
        followUps: [
          ...
          },
          {
            ...
            a: 'Honestly \u2014 and it\u2019s part of why my current work looks the way it does. Building pipes that optimize for engagement and conversion teaches you exactly how the attention machine works. I didn\u2019t leave with less skill; I left with a clearer opinion about what the skill should be for.',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    index: '03',
    timecode: 'NOW',
    title: 'The Mission \u2014 AI Tools for Non-Technical People',
    leadIn:
